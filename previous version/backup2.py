        ...
        for line in files:             # iterate through lines in file
            for char in line:          # iterate through character in a line
                ...
                if "+" in temp and char != "" and re.fullmatch("([+|-][0-9]+)|([0-9]+)", char) and Qotation == True:
                    ...
                    pass
                elif "+" in temp and char != "" and re.fullmatch("([+|-][0-9]+)|([0-9]+)", char) == False:
                    printWord(temp)
                    addCount = 0
                    addFlag = False
                    char = ""
                ...
                # if "-" in temp and char != "=" and Qotation == True and re.fullmatch("([+|-][0-9]+)|([0-9]+)", char) == False:
                #     pass
                # elif "-" in temp and char != "=" and scommentFlag == True and re.fullmatch("([+|-][0-9]+)|([0-9]+)", char) == False:
                #     char = ""
                # elif "-" in temp and char != "=" and mcommentFlag == True and re.fullmatch("([+|-][0-9]+)|([0-9]+)", char) == False:
                #     pass
                # elif "-" in temp and char != "=" and re.fullmatch("([+|-][0-9]+)|([0-9]+)", char) == False:
                #     printWord(temp)
                #     minusCount = 0
